...
const Colleges: React.FC = () => {
  ...
  const filteredColleges = useMemo(() => {
    ...
    return filtered;
  }, [searchTerm, selectedStream, selectedState, sortBy]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the best government colleges near you with detailed information about courses, facilities, and admission requirements.
          </p>
        </div>
        ...
        <div className="mb-6">
          <p className="text-gray-600">
            ...
            {(searchTerm || selectedStream || selectedState) && ' matching your criteria'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {filteredColleges.map((college) => (
            <div key={college.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
              ...
              {/* Courses */}
              <div className="p-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Available Courses</h4>
                    ...
                    <div key={course.id} className="bg-gray-50 rounded-lg p-3">
                      ...
                      {college.cutoffs[course.name] && (
                        <div className="text-sm text-red-600 font-medium mt-1">
                          Last Year Cut-off: {college.cutoffs[course.name]}%
                        </div>
                      )}
                    </div>
                  ))}
        ...
        {filteredColleges.length > 0 && (
          <div className="mt-12 bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">College Locations</h3>
            <div className="bg-gray-100 rounded-lg h-64 flex items-center justify-center">
              <div className="text-center">
                <MapPin className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                <p className="text-gray-600">Interactive map integration coming soon</p>
                <p className="text-sm text-gray-500">View all colleges on an interactive map</p>
              </div>
            </div>
          </div>
        )}
